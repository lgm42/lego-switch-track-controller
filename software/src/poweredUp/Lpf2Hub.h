...
public:
  ...
  int getTachoMotorRotation() const;
  double getDistance() const;
  int getColor() const;
  int getRssi() const;
int getBatteryLevel() const;
int getBoostHubMotorRotation() const;
int getTiltX() const; 
int getTiltY() const;
int getFirmwareVersionBuild() const;
int getFirmwareVersionBugfix() const;
int getFirmwareVersionMajor() const;
int getFirmwareVersionMinor() const;
int getHardwareVersionBuild() const;
int getHardwareVersionBugfix() const;
int getHardwareVersionMajor() const;
int getHardwareVersionMinor() const;
HubType getHubType() const;
bool isButtonPressed() const;
bool isLeftRemoteUpButtonPressed() const;
bool isLeftRemoteDownButtonPressed() const;
bool isLeftRemoteStopButtonPressed() const;
bool isLeftRemoteButtonReleased() const;
bool isRightRemoteUpButtonPressed() const;
bool isRightRemoteDownButtonPressed() const;
bool isRightRemoteStopButtonPressed() const;
bool isRightRemoteButtonReleased() const;
  BLEUUID _bleUuid;
